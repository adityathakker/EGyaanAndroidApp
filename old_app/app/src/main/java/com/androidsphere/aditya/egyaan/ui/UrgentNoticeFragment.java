 ...
 */
public class UrgentNoticeFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.content_urgent_notice, container, false);
    }
    ...
    public void onStart() {
        super.onStart();
        RecyclerView recyclerView = (RecyclerView) getActivity().findViewById(R.id.recycler_view_urgent_notice);
        ...
        noticeBoardAsync.execute(AppConstants.URLs.URGENT_NOTICE);
    }
}
