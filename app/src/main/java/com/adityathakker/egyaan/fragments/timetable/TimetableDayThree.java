...
public class TimetableDayThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        viewDayThree = inflater.inflate(R.layout.content_timetable_day_common, container, false);
...
//            Toast.makeText(getContext(), "You are Offline", Toast.LENGTH_SHORT).show();
            ...
            if (!getAndSetTimetableDataFromDatabase()) {
                viewDayThree = inflater.inflate(R.layout.custom_no_data_found, container, false);
            } else {
