...
public class TimetableDayFour extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View viewDayFour = inflater.inflate(R.layout.content_timetable_day_common, container, false);
...
//            Toast.makeText(getContext(), "You are Offline", Toast.LENGTH_SHORT).show();
    ...
    public void setSharedPreferences() {
        ...
        editor.putBoolean(AppConst.Extras.IS_OPENED_TIMETABLE_FIRST_TIME_DAY_4, true);
        editor.apply();
    }

    public void addTimetableToDatabase(String dayId, String time, String teacherName, String courseName,
                                       String comment) {
        if (sharedPreferences.getBoolean(AppConst.Extras.IS_OPENED_TIMETABLE_FIRST_TIME_DAY_4, false)) {
