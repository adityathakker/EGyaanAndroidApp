...
public class TimetableDayThree extends Fragment {

    private static final String TAG = TimetableDayThree.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View viewDayThree = inflater.inflate(R.layout.content_timetable_day_common, container, false);
        recyclerView = (RecyclerView) viewDayThree.findViewById(R.id.recycler_view_time_table_day_common);
...
//            Toast.makeText(getContext(), "You are Offline", Toast.LENGTH_SHORT).show();
    ...
    public void setSharedPreferences() {
        ...
        editor.putBoolean(AppConst.Extras.IS_OPENED_TIMETABLE_FIRST_TIME_DAY_3, true);
        editor.apply();
    }

    public void addTimetableToDatabase(String dayId, String time, String teacherName, String courseName,
                                       String comment) {
        if (sharedPreferences.getBoolean(AppConst.Extras.IS_OPENED_TIMETABLE_FIRST_TIME_DAY_3, false)) {
