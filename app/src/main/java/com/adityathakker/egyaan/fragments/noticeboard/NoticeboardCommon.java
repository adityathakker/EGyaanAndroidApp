...
public class NoticeboardCommon extends Fragment {

    private static final String TAG = NoticeboardCommon.class.getSimpleName();
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status.equals(AppConst.Statuses.SUCCESS)) {
                        for (int i = 0; i < models.get(0).getNoticeboard().size(); i++) {
                            ...
                            if (noticeType.equals("c")) {
                                noticeboardModelList.add(noticeboardModel);
                            } else {
                                Log.e(TAG, "onResponse: Branch Notice.");
                            }
                        }
